...
url = r"https://www.polyvore.com/cgi/search.sets?.in=json&.out=jsonx&request=%7B%22query%22%3A%22casual%22%2C%22.search_src%22%3A%22masthead_search%22%2C%22page%22%3Anull%2C%22.passback%22%3A%7B%22next_token%22%3A%7B%22limit%22%3A%2230%22%2C%22start%22%3A"
endurl = "%7D%7D%7D"
imgdatas = []
for i in range(30, 1000000, 30):
    ...
    print(i)
    with open('ployvoreJsonCasual.json', 'w') as file_ob:
